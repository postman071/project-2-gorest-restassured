...
public class UserExtractionTest
{
    ...
    //10. Get email of the object where name =Esha Abbott MD
    @Test
    public void test010() {
        String email = response.extract().path("find{it.name == 'Esha Abbott MD'}.email");
        System.out.println("------------------StartingTest---------------------------");
    ...
    @Test
    public void test011() {
        String gender = response.extract().path("find{it.id == 4040689}.gender");
        System.out.println("------------------StartingTest---------------------------");
